...
def get_dcdevices(routers, uid, dc_name, writer):
    ...
    for device in dc_devices:
        ...
        writer.writerow([dc_name, data['id'], data['ipAddressString'], osModel, data['productionStateLabel'],
                         data['collector']])
        # print(data)
        #exit()
...
def get_alldevices(routers):
    ...
    csvfile = open('devices_list_transit.csv', 'w')
    ...
    for device_class in device_classes:
        ...
        device_count += get_dcdevices(routers, dc_uid, device_class['name'], writer)
